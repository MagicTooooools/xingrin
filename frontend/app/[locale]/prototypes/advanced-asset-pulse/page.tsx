...
const ForensicTimeline = withRealData(({ data }) => {
  ...
  const SeriesToggle = ({ id, label, color, current, onClick }: { id: string, label: string, color: string, current: string, onClick: () => void }) => (
    <button 
      onClick={onClick}
      className={cn(
        "flex items-center gap-2 px-2 py-1 text-[10px] uppercase font-bold border transition-all",
        current === id 
             ...
             {(Object.keys(config) as Array<keyof typeof config>).map(key => {
                ...
                return (
                   <button
                      ...
                      className={cn(
                         "w-full text-left p-4 border-b border-border transition-all hover:bg-secondary/20 relative",
          ...
          {(Object.keys(config) as Array<keyof typeof config>).map(key => {
             ...
             return (
                <button
                   ...
                   onClick={() => setActiveTab(key)}
                   className={cn(
                      "flex-1 min-w-[140px] p-4 border-r border-border transition-all relative group text-left",
             ...
             {(Object.keys(config) as Array<keyof typeof config>).map(key => {
                ...
                return (
                   <button
                      ...
                      onClick={() => setActiveTab(key)}
                      className={cn(
                         "w-full text-left p-3 border-b border-border transition-all hover:bg-card/80 group h-[72px] flex items-center justify-between",
  ...
  return (
    <div className="w-full border border-border bg-card overflow-hidden flex flex-col h-[320px] relative">
       ...
       <div className="absolute top-4 left-4 z-10 flex flex-col gap-1">
           <label className="text-[10px] font-mono font-bold text-muted-foreground uppercase">Metric Focus</label>
          ...
          {(Object.keys(config) as Array<keyof typeof config>).map(key => {
             ...
             return (
                <button
                   ...
                   onClick={() => setActiveTab(key)}
                   className={cn(
                      "flex-1 p-3 border-r border-primary/30 transition-all relative text-center uppercase text-xs tracking-widest",
          ...
          {(Object.keys(config) as Array<keyof typeof config>).map(key => {
             ...
             return (
                <button
                   ...
                   onClick={() => setActiveTab(key)}
                   className={cn(
                      "flex-1 p-3 rounded-lg transition-all text-left border",
          ...
          {(Object.keys(config) as Array<keyof typeof config>).map(key => {
             ...
             return (
                <button
                   ...
                   onClick={() => setActiveTab(key)}
                   className={cn(
                      "flex-1 py-4 transition-all relative text-center group",
          ...
          {(Object.keys(config) as Array<keyof typeof config>).map(key => {
             ...
             return (
                <button
                   ...
                   onClick={() => setActiveTab(key)}
                   className={cn(
                      "flex flex-col items-start transition-all group",
       ...
       <div className="w-[100px] flex flex-col justify-center gap-4 p-2 z-10 border-r border-border bg-secondary/10">
          {(Object.keys(config) as Array<keyof typeof config>).map(key => (
             <button
                ...
                onClick={() => setActiveTab(key)}
                className={cn(
                   "w-full aspect-square rounded-full border-2 flex items-center justify-center transition-all",
  ...
  return (
    <div className="w-full border border-border bg-card overflow-hidden flex flex-col h-[450px]">
       {(Object.keys(config) as Array<keyof typeof config>).map(key => {
          ...
          return (
             <div key={key} className="flex flex-col flex-1 transition-all overflow-hidden border-b border-border last:border-0" style={{ flexGrow: isActive ? 5 : 1 }}>
                <button 
                   onClick={() => setActiveTab(key)}
                   className={cn(
...
const GallerySlider = withRealData(({ data }) => {
  ...
  return (
    <div className="w-full border border-border bg-card overflow-hidden flex flex-col h-[400px] relative group">
       {/* Navigation Arrows */}
       <button onClick={prev} className="absolute left-2 top-1/2 -translate-y-1/2 z-20 w-8 h-8 rounded-full bg-secondary/50 flex items-center justify-center hover:bg-secondary transition-colors opacity-0 group-hover:opacity-100">
          <IconChevronLeft className="w-4 h-4" />
       </button>
       <button onClick={next} className="absolute right-2 top-1/2 -translate-y-1/2 z-20 w-8 h-8 rounded-full bg-secondary/50 flex items-center justify-center hover:bg-secondary transition-colors opacity-0 group-hover:opacity-100">
       ...
       <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-20 flex gap-2">
          {keys.map((k, i) => (
             <button 
                key={k} 
                onClick={() => setIndex(i)}
                className={cn("w-2 h-2 rounded-full transition-all", i === index ? "bg-foreground scale-125" : "bg-muted-foreground/30 hover:bg-muted-foreground/50")} 
             />
          ))}
       </div>
...
const DrillDownMatrix = withRealData(({ data }) => {
  ...
  const MiniChart = ({ conf }: { conf: MiniChartConfig }) => (
     <div 
        ...
        className="border border-border bg-card p-4 flex flex-col cursor-pointer hover:border-primary/50 transition-all hover:shadow-md relative group h-full"
     >
     ...
     return (
        <div className="w-full border border-border bg-card overflow-hidden flex flex-col h-[400px]">
           <div className="p-4 border-b border-border flex justify-between items-center bg-secondary/10">
              <div className="flex items-center gap-2">
                 <button onClick={() => setZoomedKey(null)} className="text-xs font-bold hover:underline flex items-center gap-1">
          ...
          {(Object.keys(config) as Array<keyof typeof config>).map(key => {
             ...
             return (
                <button
                   ...
                   onClick={() => setActiveTab(key)}
                   className={cn(
                      "flex-1 p-4 text-left transition-all relative group hover:bg-secondary/20",
          ...
          {(Object.keys(config) as Array<keyof typeof config>).map(key => {
             ...
             return (
                <button
                   ...
                   onClick={() => setActiveTab(key)}
                   className={cn(
                      "flex-1 py-3 px-2 rounded font-bold text-xs uppercase tracking-tight transition-all active:scale-95 shadow-md border-b-2",
                      isActive 
             ...
             {(Object.keys(config) as Array<keyof typeof config>).map(key => {
                ...
                return (
                   <button
                      ...
                      onClick={() => setActiveTab(key)}
                      className={cn(
                         "flex-1 p-4 text-left border-b border-border last:border-b-0 transition-all flex flex-col justify-center relative overflow-hidden group",
          ...
          {(Object.keys(config) as Array<keyof typeof config>).map(key => {
             ...
             return (
                <button
                   ...
                   onClick={() => setActiveTab(key)}
                   className={cn(
                      "flex-1 py-3 text-xs border-r border-border transition-all flex items-center justify-center gap-2",
       ...
       <div className="flex-1 p-6 relative z-10 flex gap-6">
          ...
          <div className="w-[140px] flex flex-col gap-4 py-2">
             <div className="border border-border bg-card p-3 shadow-sm relative overflow-hidden group">
                <div className="absolute top-0 left-0 w-1 h-full transition-all group-hover:w-full opacity-10" style={{ backgroundColor: activeConfig.color }}></div>
          ...
          {(Object.keys(config) as Array<keyof typeof config>).map(key => {
             ...
             return (
                <button
                   ...
                   onClick={() => setActiveTab(key)}
                   className={cn(
                      "flex flex-col p-3 border-r border-primary last:border-r-0 transition-all text-left relative overflow-hidden group hover:bg-secondary/10",
          ...
          {(Object.keys(config) as Array<keyof typeof config>).map(key => {
             ...
             return (
                <button
                   ...
                   onClick={() => setActiveTab(key)}
                   className={cn(
                      "flex-1 py-3 px-4 rounded-lg flex items-center justify-between transition-all",
             ...
             {(Object.keys(config) as Array<keyof typeof config>).map(key => {
                ...
                return (
                   <button
                      ...
                      onClick={() => setActiveTab(key)}
                      className={cn(
                         "flex-1 h-12 rounded-md flex items-center justify-between px-4 transition-all shadow-[0_2px_0_0_rgba(0,0,0,0.1)] active:shadow-none active:translate-y-[2px]",
                         isActive 
             ...
             return (
                ...
                >
                   ...
                   <div className={cn(
                      ...
                      <div className={cn(
                         "absolute top-1 w-4 h-4 rounded-full shadow-md transition-all duration-200",
                         isActive 
          ...
          {(Object.keys(config) as Array<keyof typeof config>).map(key => {
             ...
             return (
                <button
                   ...
                   onClick={() => setActiveTab(key)}
                   className={cn(
                      "flex-1 min-w-[120px] py-3 px-4 rounded-t-lg border-t-2 border-l-2 border-r-2 transition-all relative top-[2px] z-10",
                      isActive 
          ...
          {(Object.keys(config) as Array<keyof typeof config>).map(key => {
             ...
             return (
                <button
                   ...
                   onClick={() => setActiveTab(key)}
                   className={cn(
                      "flex-1 flex flex-col items-center justify-center gap-2 transition-all relative group",
                      isActive ? "bg-card" : "hover:bg-secondary/20"
                   )}
                >
