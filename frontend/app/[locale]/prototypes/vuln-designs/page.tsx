          ...
          <div className="aspect-square h-full flex items-center justify-center">
             <div className="grid grid-cols-10 gap-1.5 w-full max-w-[220px]">
                {dots.map((dot, i) => (
                   <div 
                      key={i} 
                      className="aspect-square rounded-[1px] transition-all hover:scale-125 hover:z-10"
             ...
             return (
                <div key={d.label} className="flex flex-col items-center gap-2 group h-full justify-end w-12">
                   ...
                   <div className="w-full relative bg-muted/20 border border-border/50 rounded-sm overflow-hidden" style={{height: '100%'}}>
                      <div 
                         className="absolute bottom-0 w-full transition-all duration-500 ease-out flex flex-col-reverse gap-[1px]" 
                        ...
                        {[...Array(12)].map((_, i) => {
                           ...
                           return (
                              <div 
                                 key={i} 
                                 className={cn(
                                    "w-full h-1.5 rounded-[1px] transition-all duration-300",
                   ...
                   {[0, 1, 2, 3, 4].map((col, j) => {
                      ...
                      return (
                         <div 
                            key={j} 
                            className={cn(
                               "w-8 h-7 text-[0px] relative clip-path-hex transition-all hover:scale-110 hover:z-10",
                               color,
             ...
             {MOCK_DATA.map((d) => (
                <div key={d.label} className="flex items-center gap-4 group">
                   ...
                   <div className="flex-1 h-8 relative flex items-center">
                      ...
                      <div className="absolute left-0 h-[2px] transition-all duration-500 ease-out" 
                           style={{width: `${(d.count / 200) * 100}%`, backgroundColor: d.fill}}></div>
                           
                      {/* Node */}
                      <div className="absolute w-3 h-3 border-2 border-background rounded-full transition-all duration-500"
             ...
             return (
                <div key={d.label} className="group relative flex items-center gap-4">
                   ...
                   <div className="flex-1 h-8 bg-muted/10 relative">
                      <div 
                         className="absolute top-0 bottom-0 left-0 bg-gradient-to-r from-transparent to-black/10 dark:to-white/10 transition-all duration-500 group-hover:brightness-110"
                         style={{ 
                            width: width,
