            ...
            <div className="flex flex-wrap items-center gap-6 rounded-lg border border-dashed p-6">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="flex items-center rounded-full border bg-background p-1 shadow-sm">
                  <a href="#" className="flex items-center gap-1.5 rounded-full bg-zinc-900 px-3 py-1 text-xs font-medium text-white transition-colors hover:bg-zinc-800 dark:bg-zinc-50 dark:text-zinc-900">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-8 rounded-lg border border-dashed p-6">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium rounded-sm bg-gradient-to-br from-[#fcee0a] to-[#00f0ff] hover:text-white focus:outline-none">
                  <span className="relative flex items-center px-4 py-1.5 transition-all ease-in duration-75 bg-black text-[#fcee0a] rounded-sm group-hover:bg-opacity-90 font-mono tracking-wider uppercase border border-[#fcee0a]/30 shadow-[0_0_15px_rgba(252,238,10,0.3)]">
                    <IconBrandGithub className="mr-2 size-4" />
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative inline-flex items-center justify-center overflow-hidden text-sm font-medium rounded-sm bg-[#fcee0a] text-black hover:bg-[#e6d809] focus:outline-none shadow-[4px_4px_0px_#000000]">
                  <span className="relative flex items-center px-5 py-2 transition-all ease-in duration-75 font-mono tracking-wider uppercase border-2 border-black">
                    <IconBrandGithub className="mr-2 size-4" />
                    <span className="mr-2 font-bold">STAR</span>
                    <span className="border-l-2 border-black pl-2 font-bold">{stars?.toLocaleString() ?? "2077"}</span>
                  </span>
                  {/* Glitch overlay */}
                  <span className="absolute top-0 left-0 w-full h-full bg-[#00f0ff] mix-blend-multiply opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all duration-75 pointer-events-none" />
                </a>
              </div>
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-9 bg-[#F5F5F5] text-zinc-900 border border-zinc-300 hover:border-[#00C8FF] transition-all overflow-hidden min-w-[120px]">
              ...
              <div className="flex flex-col items-center gap-2">
                <span className="text-xs text-muted-foreground">Arknights (Light)</span>
                <a href="#" className="group relative flex items-center h-10 bg-white border-l-4 border-l-[#00C8FF] border-y border-r border-y-zinc-200 border-r-zinc-200 min-w-[140px] hover:bg-zinc-50 transition-colors">
               ...
               <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group flex items-center h-9 bg-white border-2 border-black relative overflow-hidden min-w-[130px] hover:shadow-[4px_4px_0px_#000] transition-shadow">
                  {/* Barcode Strip */}
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-9 bg-[#222] text-white min-w-[120px] overflow-hidden">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center justify-center h-9 px-6 bg-[#2B2B2B]/90 backdrop-blur-sm border border-[#444] hover:border-[#eee] transition-colors overflow-hidden">
                  {/* Hexagon Pattern */}
                  ...
                  {/* Corner Brackets */}
                  <div className="absolute top-1 left-1 w-2 h-2 border-t border-l border-[#888] opacity-50 group-hover:opacity-100 group-hover:w-3 group-hover:h-3 transition-all" />
                  <div className="absolute bottom-1 right-1 w-2 h-2 border-b border-r border-[#888] opacity-50 group-hover:opacity-100 group-hover:w-3 group-hover:h-3 transition-all" />
                </a>
              </div>
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-9 bg-white border border-zinc-200 rounded-sm overflow-hidden min-w-[130px] shadow-sm hover:shadow-md transition-all">
                  {/* Orange Accent Bar */}
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center justify-center h-9 px-5 bg-[#F5F5F0] border border-[#D4AF37] text-[#333] overflow-hidden rounded-[2px] shadow-[0_2px_10px_rgba(212,175,55,0.1)] hover:shadow-[0_4px_15px_rgba(212,175,55,0.25)] transition-shadow">
               ...
               <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-9 bg-slate-50 border border-slate-200 overflow-hidden min-w-[120px]">
                   {/* Ice Gradient */}
               ...
               <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-9 bg-white border border-blue-600 shadow-sm overflow-hidden min-w-[130px]">
                  {/* Left Stripe */}
               ...
               <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center justify-center h-9 px-4 bg-white border-2 border-transparent bg-clip-padding rounded-sm overflow-hidden">
                   {/* Neon Border Effect */}
               ...
               <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-9 bg-white min-w-[140px] shadow-sm rounded-tl-xl rounded-br-xl border-t-2 border-b-2 border-[#1289F4] overflow-visible hover:-translate-y-0.5 transition-transform">
                   
                   {/* Halo Effect */}
                   <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-8 h-2 border border-pink-400/50 rounded-[50%] opacity-0 group-hover:opacity-100 group-hover:-top-4 transition-all duration-500" />
               ...
               <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group flex items-center gap-3 bg-[#DAD4BB] text-[#4D4D4D] px-4 py-1.5 border border-[#4D4D4D] shadow-[2px_2px_0px_#4D4D4D] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[1px_1px_0px_#4D4D4D] transition-all relative overflow-hidden">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative h-9 w-28 mt-1">
                   {/* Background Layer */}
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-8 rounded-lg border p-6 bg-zinc-100">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-10 bg-[#F0F2F5] border-2 border-[#8A95A5] text-[#3E4856] min-w-[140px] hover:bg-white transition-colors">
                   {/* Left Accent */}
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-10 bg-white border border-zinc-300 shadow-sm overflow-hidden min-w-[150px] hover:border-red-500 transition-colors">
                   {/* Caution Strip */}
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-9 bg-white border border-red-600 text-red-600 hover:bg-red-50 transition-colors min-w-[130px] shadow-[2px_2px_0px_#dc2626]">
                   {/* Hex pattern overlay */}
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-10 bg-white border-2 border-zinc-800 border-t-[4px] border-t-[#FFD700] min-w-[140px] hover:-translate-y-0.5 transition-transform">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-10 bg-white border border-zinc-200 min-w-[150px] overflow-hidden hover:shadow-md transition-shadow">
                   {/* Split Background */}
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-9 bg-[#F5F5DC] border border-[#8B8B83] text-[#4A4A4A] min-w-[140px] hover:bg-[#EEEEE0] transition-colors">
                   {/* Rank Stripe */}
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-10 bg-white/80 backdrop-blur border border-emerald-500/30 text-emerald-700 min-w-[140px] overflow-hidden hover:border-emerald-500 hover:text-emerald-600 transition-all">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-10 bg-white border-l-4 border-l-[#F85A3E] border-y border-r border-y-zinc-200 border-r-zinc-200 min-w-[140px] hover:bg-zinc-50 transition-colors">
                   <div className="flex-1 flex flex-col justify-center px-3">
                      <div className="flex items-center justify-between mb-0.5">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-8 rounded-lg border p-6 bg-white">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-9 px-4 bg-white border border-zinc-100 rounded-sm shadow-[0_1px_2px_rgba(0,0,0,0.05)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.08)] hover:-translate-y-0.5 transition-all duration-300">
                   <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="relative p-[1px] rounded-full bg-gradient-to-br from-zinc-200 to-zinc-100">
                   <a href="#" className="flex items-center gap-2 h-8 px-4 bg-white/60 backdrop-blur-md rounded-full hover:bg-white/80 transition-colors">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group flex items-center gap-2 py-1">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="flex items-center gap-2 h-8 px-3 rounded-md hover:bg-zinc-50 transition-colors">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-8 rounded-lg border p-6 bg-rose-50/30">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-10 px-1 bg-white border-2 border-pink-300 rounded-full shadow-[4px_4px_0px_#f9a8d4] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_#f9a8d4] transition-all">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center justify-center w-32 h-10 bg-white border-2 border-black overflow-hidden hover:bg-zinc-50 transition-colors">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-9 bg-white rounded-md border border-purple-200 shadow-sm overflow-hidden min-w-[130px] hover:border-purple-400 transition-colors">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-10 w-32 bg-amber-50 border-2 border-[#D4AF37] rounded-sm shadow-sm hover:-translate-y-1 transition-transform">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-9 bg-[#E6D6BF] border-2 border-[#5C4033] shadow-[2px_2px_0px_#5C4033] active:translate-y-[2px] active:shadow-none active:translate-x-[2px] transition-all rounded-[2px] min-w-[130px]">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-8 rounded-lg border border-dashed p-6">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group flex items-center gap-2 h-8 px-3 rounded-md border border-zinc-200 bg-white hover:border-zinc-300 hover:shadow-sm transition-all">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group relative flex items-center h-8 bg-white border border-zinc-200 text-zinc-800 rounded-md shadow-sm overflow-hidden pr-3 hover:border-zinc-300 hover:shadow-md transition-all duration-300">
                   ...
                   <div className="flex items-center gap-2 px-2">
                      ...
                      <div className="flex items-center gap-1">
                         ...
                         <IconStarFilled className="w-0 overflow-hidden group-hover:w-3 size-3 text-amber-400 transition-all duration-300" />
                      </div>
                   </div>
                </a>
              </div>
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="flex items-center p-0.5 rounded-full border border-zinc-200 bg-zinc-50/50 shadow-sm">
                   <a href="#" className="flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-zinc-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group flex items-center h-8 bg-[#F4F4F5] border border-[#E4E4E7] rounded-sm hover:bg-white hover:border-[#D4D4D8] transition-all">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-8 rounded-lg border border-dashed p-6">
                ...
                >
                  <a href="#" className="flex items-center group">
                    ...
                    <div className="flex h-full items-center border-l px-3 bg-muted/20 group-hover:bg-muted/40 transition-colors">
                      ...
                      <IconStarFilled className="ml-1.5 size-3 text-amber-400 opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all" />
                    </div>
                  </a>
                </Button>
              </div>
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <a href="#" className="group flex items-center h-8 rounded-full border bg-background hover:border-foreground/20 hover:shadow-sm transition-all overflow-hidden">
                   <div className="flex items-center gap-2 px-3 py-1">
