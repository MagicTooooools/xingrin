...
import type { EngineYamlError } from "@/components/scan/engine/engine-create-dialog-state"

type TranslationFn = (key: string, params?: Record<string, string | number | Date>) => string

interface EngineCreatePresetStepProps {
  presetEngines: PresetEngine[]
  selectedPreset: PresetEngine | null
  onSelectPreset: (preset: PresetEngine) => void
  onCancel: () => void
  onNext: () => void
  t: TranslationFn
  tEngine: TranslationFn
  tCommon: TranslationFn
}

export function EngineCreatePresetStep({
  presetEngines,
  selectedPreset,
  onSelectPreset,
  onCancel,
...
interface EngineCreateConfigStepProps {
  engineName: string
  onEngineNameChange: (value: string) => void
  yamlContent: string
  onYamlChange: (value: string) => void
  yamlError: EngineYamlError
...
export function EngineCreateConfigStep({
  engineName,
  onEngineNameChange,
  yamlContent,
  onYamlChange,
