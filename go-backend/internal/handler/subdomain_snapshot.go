...
type SubdomainSnapshotHandler struct {
	svc *service.SubdomainSnapshotService
}

// NewSubdomainSnapshotHandler creates a new subdomain snapshot handler
func NewSubdomainSnapshotHandler(svc *service.SubdomainSnapshotService) *SubdomainSnapshotHandler {
...
func toSubdomainSnapshotResponse(s *model.SubdomainSnapshot) dto.SubdomainSnapshotResponse {
