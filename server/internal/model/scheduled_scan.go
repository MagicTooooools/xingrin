...
type ScheduledScan struct {
	...
	Name              string         `gorm:"column:name;size:200;index:idx_scheduled_scan_name" json:"name"`
	...
	IsEnabled         bool           `gorm:"column:is_enabled;default:true;index:idx_scheduled_scan_enabled" json:"isEnabled"`
	...
	CreatedAt         time.Time      `gorm:"column:created_at;autoCreateTime;index:idx_scheduled_scan_created_at" json:"createdAt"`
